...
<head>
    ...
    <link rel="stylesheet" href="/app-fundacion/views/home/quizzes/css/edit_quizz.css">
...
<body>
    ...
    <div class="container">
        <div class="section-title">
            <h3 class=" font-weight-bold style-title">Editar encuesta</h3>
        </div>
            ...
            <form>
                ...
                <div class="row mt-4">
                    <div class="col col-md-4">
                        ...
                        <div class="input-group date fj-date fi-date">
                            ...
                            <input type="text" class="form-control border-style" id="input-date1" class="input-datei" name="input-datei"><span class="input-group-addon"></span>
                        </div>
                    </div>
                    <div class="col col-md-4">
                        ...
                        <div class="input-group date fj-date fl-date">
                            ...
                            <input type="text" class="form-control border-style" id="input-date2" class="input-datel" name="input-datel"><span class="input-group-addon"></span>
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col col-md-4 offset-md-4">
                        <label for="input-state" class="form-label text-style font-weight-bold d-block">Estado</label>
                        <select class="form-control form-control-sm border-style" id="input-state">
                ...
                <div class="row">
                    <div class="col col-md-8">
                        <button class="btn btn-style float-right editQuizz">
                            <span class="continue">Actualizar</span>
                        </button>
...
<script src="/app-fundacion/views/home/quizzes/js/edit_quizz.js"></script>
</body>
</html>